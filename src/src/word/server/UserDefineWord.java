...
public class UserDefineWord extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String MYSQL_USER = new String(request.getParameter("mysql_user"));
        ...
        String ResInfo = "Fail";
        try {
        	   SQL.insert(MYSQL_USER, PASS, DB_URL, 3, new String[]{user, word, pron, pron_link, form, meaning, sentence_eng, sentence_chn, "3"});
        	   ResInfo = "Success";
